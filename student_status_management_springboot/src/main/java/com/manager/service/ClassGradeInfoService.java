...
//        System.out.println(classGradeInfoMapper.getClassGradeInfo(classGradeInfoView));
    ...
    public Map<String, Object> insertGrade(Map<String,Object> params) throws Exception {
        ...
        chaincodeService.ChangeGrade(classGradeInfoView.getCname(), classGradeInfoView.getSid(), classGradeInfoView.getGrade());
        return  MypageHelper(params,classGradeInfoMapper.getClassGradeInfo(new ClassGradeInfoView()));
    }

    @Transactional(rollbackFor = {RuntimeException.class, Error.class})
    public Map<String, Object> insertGradeMakeup(Map<String, Object> params) throws Exception {
        ClassGradeInfoView classGradeInfoView = new ClassGradeInfoView();
        classGradeInfoView.setCname(params.get("cname")==""?null:(String)params.get("cname"));
        //classGradeInfoView.setStudentName(params.get("studentName")==""?null:(String)params.get("studentName"));
        //如果值不存在那么，就直接返回错误
        ...
        chaincodeService.ChangeMakeupGrade(classGradeInfoView.getCname(), classGradeInfoView.getSid(), classGradeInfoView.getMakeupGrade());
        return  MypageHelper(params,classGradeInfoMapper.getClassGradeInfo(new ClassGradeInfoView()));
    }
}