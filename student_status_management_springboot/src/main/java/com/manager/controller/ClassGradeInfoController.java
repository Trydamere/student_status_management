...
public class ClassGradeInfoController {
    ...
    public  Map<String, Object> insert(@RequestBody Map<String,Object> params) throws Exception {
        System.out.println(params);
        return classGradeInfoService.insertGrade(params);
    }

    @PostMapping("/ClassGradeInfo/insertMakeup")
    public  Map<String, Object> insertMakeup(@RequestBody Map<String,Object> params) throws Exception {
        System.out.println(params);
